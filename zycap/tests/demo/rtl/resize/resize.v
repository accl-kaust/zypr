...
(* CORE_GENERATION_INFO="resize,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.413000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=1,HLS_SYN_DSP=7,HLS_SYN_FF=2984,HLS_SYN_LUT=5032,HLS_VERSION=2019_2}" *)
...
wire   [31:0] Block_Mat_exit1_proc_U0_in_mat_rows_out_din;
wire    Block_Mat_exit1_proc_U0_in_mat_rows_out_write;
wire   [31:0] Block_Mat_exit1_proc_U0_in_mat_cols_out_din;
wire    Block_Mat_exit1_proc_U0_in_mat_cols_out_write;
wire   [31:0] Block_Mat_exit1_proc_U0_out_mat_rows_out_din;
wire    Block_Mat_exit1_proc_U0_out_mat_rows_out_write;
wire   [31:0] Block_Mat_exit1_proc_U0_out_mat_cols_out_din;
wire    Block_Mat_exit1_proc_U0_out_mat_cols_out_write;
...
wire    resize_1_U0_ap_start;
wire    resize_1_U0_ap_done;
wire    resize_1_U0_ap_continue;
wire    resize_1_U0_ap_idle;
wire    resize_1_U0_ap_ready;
wire    resize_1_U0_start_out;
wire    resize_1_U0_start_write;
wire    resize_1_U0_p_src_rows_read;
wire    resize_1_U0_p_src_cols_read;
wire    resize_1_U0_p_src_data_V_read;
wire    resize_1_U0_p_dst_rows_read;
wire    resize_1_U0_p_dst_cols_read;
wire   [7:0] resize_1_U0_p_dst_data_V_din;
wire    resize_1_U0_p_dst_data_V_write;
wire   [31:0] resize_1_U0_p_dst_rows_out_din;
wire    resize_1_U0_p_dst_rows_out_write;
wire   [31:0] resize_1_U0_p_dst_cols_out_din;
wire    resize_1_U0_p_dst_cols_out_write;
...
wire   [0:0] start_for_resize_1_U0_din;
wire    start_for_resize_1_U0_full_n;
wire   [0:0] start_for_resize_1_U0_dout;
wire    start_for_resize_1_U0_empty_n;
...
resize_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
resize_AXILiteS_s_axi_U(
...
Block_Mat_exit1_proc Block_Mat_exit1_proc_U0(
    ...
    .start_full_n(start_for_resize_1_U0_full_n),
    ...
    .rows_out(rows_out),
    .cols_out(cols_out),
    .in_mat_rows_out_din(Block_Mat_exit1_proc_U0_in_mat_rows_out_din),
    .in_mat_rows_out_full_n(in_mat_rows_c_full_n),
    .in_mat_rows_out_write(Block_Mat_exit1_proc_U0_in_mat_rows_out_write),
    .in_mat_cols_out_din(Block_Mat_exit1_proc_U0_in_mat_cols_out_din),
    .in_mat_cols_out_full_n(in_mat_cols_c_full_n),
    .in_mat_cols_out_write(Block_Mat_exit1_proc_U0_in_mat_cols_out_write),
    .out_mat_rows_out_din(Block_Mat_exit1_proc_U0_out_mat_rows_out_din),
    .out_mat_rows_out_full_n(out_mat_rows_c_full_n),
    .out_mat_rows_out_write(Block_Mat_exit1_proc_U0_out_mat_rows_out_write),
    .out_mat_cols_out_din(Block_Mat_exit1_proc_U0_out_mat_cols_out_din),
    .out_mat_cols_out_full_n(out_mat_cols_c_full_n),
    .out_mat_cols_out_write(Block_Mat_exit1_proc_U0_out_mat_cols_out_write)
);
...
resize_1 resize_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(resize_1_U0_ap_start),
    .start_full_n(start_for_xfMat2AXIstream_U0_full_n),
    .ap_done(resize_1_U0_ap_done),
    .ap_continue(resize_1_U0_ap_continue),
    .ap_idle(resize_1_U0_ap_idle),
    .ap_ready(resize_1_U0_ap_ready),
    .start_out(resize_1_U0_start_out),
    .start_write(resize_1_U0_start_write),
    .p_src_rows_dout(in_mat_rows_c9_dout),
    .p_src_rows_empty_n(in_mat_rows_c9_empty_n),
    .p_src_rows_read(resize_1_U0_p_src_rows_read),
    .p_src_cols_dout(in_mat_cols_c10_dout),
    .p_src_cols_empty_n(in_mat_cols_c10_empty_n),
    .p_src_cols_read(resize_1_U0_p_src_cols_read),
    .p_src_data_V_dout(in_mat_data_V_dout),
    .p_src_data_V_empty_n(in_mat_data_V_empty_n),
    .p_src_data_V_read(resize_1_U0_p_src_data_V_read),
    .p_dst_rows_dout(out_mat_rows_c_dout),
    .p_dst_rows_empty_n(out_mat_rows_c_empty_n),
    .p_dst_rows_read(resize_1_U0_p_dst_rows_read),
    .p_dst_cols_dout(out_mat_cols_c_dout),
    .p_dst_cols_empty_n(out_mat_cols_c_empty_n),
    .p_dst_cols_read(resize_1_U0_p_dst_cols_read),
    .p_dst_data_V_din(resize_1_U0_p_dst_data_V_din),
    .p_dst_data_V_full_n(out_mat_data_V_full_n),
    .p_dst_data_V_write(resize_1_U0_p_dst_data_V_write),
    .p_dst_rows_out_din(resize_1_U0_p_dst_rows_out_din),
    .p_dst_rows_out_full_n(out_mat_rows_c11_full_n),
    .p_dst_rows_out_write(resize_1_U0_p_dst_rows_out_write),
    .p_dst_cols_out_din(resize_1_U0_p_dst_cols_out_din),
    .p_dst_cols_out_full_n(out_mat_cols_c12_full_n),
    .p_dst_cols_out_write(resize_1_U0_p_dst_cols_out_write)
);
...
xfMat2AXIstream xfMat2AXIstream_U0(
    ...
    .img_rows_dout(out_mat_rows_c11_dout),
    .img_rows_empty_n(out_mat_rows_c11_empty_n),
    .img_rows_read(xfMat2AXIstream_U0_img_rows_read),
    .img_cols_dout(out_mat_cols_c12_dout),
    .img_cols_empty_n(out_mat_cols_c12_empty_n),
...
fifo_w32_d2_A in_mat_rows_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit1_proc_U0_in_mat_rows_out_din),
    .if_full_n(in_mat_rows_c_full_n),
    .if_write(Block_Mat_exit1_proc_U0_in_mat_rows_out_write),
...
fifo_w32_d2_A in_mat_cols_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit1_proc_U0_in_mat_cols_out_din),
    .if_full_n(in_mat_cols_c_full_n),
    .if_write(Block_Mat_exit1_proc_U0_in_mat_cols_out_write),
    .if_dout(in_mat_cols_c_dout),
    .if_empty_n(in_mat_cols_c_empty_n),
    .if_read(AXIstream2xfMat_U0_img_cols_read)
);

fifo_w32_d3_A out_mat_rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit1_proc_U0_out_mat_rows_out_din),
    .if_full_n(out_mat_rows_c_full_n),
    .if_write(Block_Mat_exit1_proc_U0_out_mat_rows_out_write),
    .if_dout(out_mat_rows_c_dout),
    .if_empty_n(out_mat_rows_c_empty_n),
    .if_read(resize_1_U0_p_dst_rows_read)
);

fifo_w32_d3_A out_mat_cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Block_Mat_exit1_proc_U0_out_mat_cols_out_din),
    .if_full_n(out_mat_cols_c_full_n),
    .if_write(Block_Mat_exit1_proc_U0_out_mat_cols_out_write),
    .if_dout(out_mat_cols_c_dout),
    .if_empty_n(out_mat_cols_c_empty_n),
    .if_read(resize_1_U0_p_dst_cols_read)
);
...
fifo_w8_d2_A in_mat_data_V_U(
    ...
    .if_read(resize_1_U0_p_src_data_V_read)
);
...
fifo_w32_d2_A in_mat_rows_c9_U(
    ...
    .if_read(resize_1_U0_p_src_rows_read)
);
...
fifo_w32_d2_A in_mat_cols_c10_U(
    ...
    .if_read(resize_1_U0_p_src_cols_read)
);
...
fifo_w8_d2_A out_mat_data_V_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(resize_1_U0_p_dst_data_V_din),
    .if_full_n(out_mat_data_V_full_n),
    .if_write(resize_1_U0_p_dst_data_V_write),
    .if_dout(out_mat_data_V_dout),
    .if_empty_n(out_mat_data_V_empty_n),
    .if_read(xfMat2AXIstream_U0_img_data_V_read)
);

fifo_w32_d2_A out_mat_rows_c11_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(resize_1_U0_p_dst_rows_out_din),
    .if_full_n(out_mat_rows_c11_full_n),
    .if_write(resize_1_U0_p_dst_rows_out_write),
    .if_dout(out_mat_rows_c11_dout),
    .if_empty_n(out_mat_rows_c11_empty_n),
    .if_read(xfMat2AXIstream_U0_img_rows_read)
);

fifo_w32_d2_A out_mat_cols_c12_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(resize_1_U0_p_dst_cols_out_din),
    .if_full_n(out_mat_cols_c12_full_n),
    .if_write(resize_1_U0_p_dst_cols_out_write),
    .if_dout(out_mat_cols_c12_dout),
    .if_empty_n(out_mat_cols_c12_empty_n),
    .if_read(xfMat2AXIstream_U0_img_cols_read)
);

start_for_resize_jbC start_for_resize_jbC_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_resize_1_U0_din),
    .if_full_n(start_for_resize_1_U0_full_n),
    .if_write(Block_Mat_exit1_proc_U0_start_write),
    .if_dout(start_for_resize_1_U0_dout),
    .if_empty_n(start_for_resize_1_U0_empty_n),
    .if_read(resize_1_U0_ap_ready)
);
...
start_for_xfMat2AkbM start_for_xfMat2AkbM_U(
    ...
    .if_write(resize_1_U0_start_write),
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == Block_Mat_exit1_proc_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Block_Mat_exit1_proc_U0_ap_ready_count <= (Block_Mat_exit1_proc_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit1_proc_U0_ap_continue = 1'b1;
...
assign ap_idle = (xfMat2AXIstream_U0_ap_idle & resize_1_U0_ap_idle & Block_Mat_exit1_proc_U0_ap_idle & AXIstream2xfMat_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_Block_Mat_exit1_proc_U0_ap_ready & ap_sync_AXIstream2xfMat_U0_ap_ready);

assign resize_1_U0_ap_continue = 1'b1;

assign resize_1_U0_ap_start = start_for_resize_1_U0_empty_n;

assign start_for_resize_1_U0_din = 1'b1;
