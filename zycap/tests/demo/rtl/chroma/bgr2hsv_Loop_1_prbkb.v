...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module bgr2hsv_Loop_1_prbkb_rom (
...
initial begin
    $readmemh("./bgr2hsv_Loop_1_prbkb_rom.dat", ram0);
    $readmemh("./bgr2hsv_Loop_1_prbkb_rom.dat", ram1);
end
...
bgr2hsv_Loop_1_prbkb_rom bgr2hsv_Loop_1_prbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
