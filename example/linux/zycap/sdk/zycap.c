...
int main() {
    ...
    unsigned int* virtual_source_address  = mmap(NULL, 65535, PROT_READ | PROT_WRITE, MAP_SHARED, dh, 0x6fd00000); // Memory map source address
...
//    dma_s2mm_status(virtual_address);
    ...
    printf("Writing MM2S transfer length...\n");
    dma_set(virtual_address, MM2S_LENGTH, 8192);
    dma_mm2s_status(virtual_address);
