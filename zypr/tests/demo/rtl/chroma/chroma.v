...
(* CORE_GENERATION_INFO="chroma,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.463313,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=4,HLS_SYN_DSP=6,HLS_SYN_FF=969,HLS_SYN_LUT=2576,HLS_VERSION=2019_2}" *)
...
parameter C_S_AXI_AXILITES_WSTRB_WIDTH = 4;
...
wire    AXIstream2xfMat_U0_start_out;
...
wire   [23:0] AXIstream2xfMat_U0_img_data_V_din;
...
wire   [31:0] AXIstream2xfMat_U0_img_rows_out1_din;
wire    AXIstream2xfMat_U0_img_rows_out1_write;
wire   [31:0] AXIstream2xfMat_U0_img_cols_out_din;
wire    AXIstream2xfMat_U0_img_cols_out_write;
wire   [31:0] AXIstream2xfMat_U0_img_cols_out2_din;
wire    AXIstream2xfMat_U0_img_cols_out2_write;
wire    bgr2hsv_U0_p_src_mat_rows_read;
wire    bgr2hsv_U0_p_src_mat_cols_read;
wire    bgr2hsv_U0_p_src_mat_data_V_read;
wire   [23:0] bgr2hsv_U0_p_dst_mat_data_V_din;
wire    bgr2hsv_U0_p_dst_mat_data_V_write;
wire    bgr2hsv_U0_ap_start;
wire    bgr2hsv_U0_ap_done;
wire    bgr2hsv_U0_ap_ready;
wire    bgr2hsv_U0_ap_idle;
wire    bgr2hsv_U0_ap_continue;
wire    inRange_U0_ap_start;
wire    inRange_U0_ap_done;
wire    inRange_U0_ap_continue;
wire    inRange_U0_ap_idle;
wire    inRange_U0_ap_ready;
wire    inRange_U0_src_rows_read;
wire    inRange_U0_src_cols_read;
wire    inRange_U0_src_data_V_read;
wire   inRange_U0_dst_data_V_din;
wire    inRange_U0_dst_data_V_write;
...
wire   xfMat2AXIstream_U0_stream_out_TLAST;
...
wire   [23:0] in_mat_data_V_dout;
wire    in_mat_data_V_empty_n;
wire    AXIstream2xfMat_U0_img_data_V_empty_n;
wire    AXIstream2xfMat_U0_img_data_V_read;
wire   [23:0] AXIstream2xfMat_U0_img_data_V_dout;
wire    in_mat_rows_c11_full_n;
wire   [31:0] in_mat_rows_c11_dout;
wire    in_mat_rows_c11_empty_n;
wire    in_mat_rows_c12_full_n;
wire   [31:0] in_mat_rows_c12_dout;
wire    in_mat_rows_c12_empty_n;
wire    in_mat_cols_c13_full_n;
wire   [31:0] in_mat_cols_c13_dout;
wire    in_mat_cols_c13_empty_n;
wire    in_mat_cols_c14_full_n;
wire   [31:0] in_mat_cols_c14_dout;
wire    in_mat_cols_c14_empty_n;
wire    out_mat_data_V_full_n;
wire   out_mat_data_V_dout;
...
wire   start_for_xfMat2AXIstream_U0_din;
wire    start_for_xfMat2AXIstream_U0_full_n;
wire   start_for_xfMat2AXIstream_U0_dout;
wire    start_for_xfMat2AXIstream_U0_empty_n;
wire   start_for_bgr2hsv_U0_din;
wire    start_for_bgr2hsv_U0_full_n;
wire   start_for_bgr2hsv_U0_dout;
wire    start_for_bgr2hsv_U0_empty_n;
wire   start_for_inRange_U0_din;
wire    start_for_inRange_U0_full_n;
wire   start_for_inRange_U0_dout;
wire    start_for_inRange_U0_empty_n;
wire    bgr2hsv_U0_start_full_n;
wire    bgr2hsv_U0_start_write;
wire    inRange_U0_start_full_n;
wire    inRange_U0_start_write;
...
AXIstream2xfMat AXIstream2xfMat_U0 (
    ...
    .start_full_n(AXIstream2xfMat_U0_start_full_n),
    ...
    .start_out(AXIstream2xfMat_U0_start_out),
    .start_write(AXIstream2xfMat_U0_start_write),
    ...
    .img_rows_out_full_n(in_mat_rows_c11_full_n),
    .img_rows_out_write(AXIstream2xfMat_U0_img_rows_out_write),
    .img_rows_out1_din(AXIstream2xfMat_U0_img_rows_out1_din),
    .img_rows_out1_full_n(in_mat_rows_c12_full_n),
    .img_rows_out1_write(AXIstream2xfMat_U0_img_rows_out1_write),
    .img_cols_out_din(AXIstream2xfMat_U0_img_cols_out_din),
    .img_cols_out_full_n(in_mat_cols_c13_full_n),
    .img_cols_out_write(AXIstream2xfMat_U0_img_cols_out_write),
    .img_cols_out2_din(AXIstream2xfMat_U0_img_cols_out2_din),
    .img_cols_out2_full_n(in_mat_cols_c14_full_n),
    .img_cols_out2_write(AXIstream2xfMat_U0_img_cols_out2_write)
);

chroma_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
chroma_AXILiteS_s_axi_U(
...
Block_Mat_exit71_pro Block_Mat_exit71_pro_U0(
    ...
    .start_full_n(start_for_xfMat2AXIstream_U0_full_n),
...
bgr2hsv bgr2hsv_U0(
    .p_src_mat_rows_dout(in_mat_rows_c11_dout),
    .p_src_mat_rows_empty_n(in_mat_rows_c11_empty_n),
    .p_src_mat_rows_read(bgr2hsv_U0_p_src_mat_rows_read),
    .p_src_mat_cols_dout(in_mat_cols_c13_dout),
    .p_src_mat_cols_empty_n(in_mat_cols_c13_empty_n),
    .p_src_mat_cols_read(bgr2hsv_U0_p_src_mat_cols_read),
    .p_src_mat_data_V_dout(24'd0),
    .p_src_mat_data_V_empty_n(1'b1),
    .p_src_mat_data_V_read(bgr2hsv_U0_p_src_mat_data_V_read),
    .p_dst_mat_data_V_din(bgr2hsv_U0_p_dst_mat_data_V_din),
    .p_dst_mat_data_V_full_n(1'b1),
    .p_dst_mat_data_V_write(bgr2hsv_U0_p_dst_mat_data_V_write),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(bgr2hsv_U0_ap_start),
    .ap_done(bgr2hsv_U0_ap_done),
    .ap_ready(bgr2hsv_U0_ap_ready),
    .ap_idle(bgr2hsv_U0_ap_idle),
    .ap_continue(bgr2hsv_U0_ap_continue)
);

inRange inRange_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(inRange_U0_ap_start),
    .ap_done(inRange_U0_ap_done),
    .ap_continue(inRange_U0_ap_continue),
    .ap_idle(inRange_U0_ap_idle),
    .ap_ready(inRange_U0_ap_ready),
    .src_rows_dout(in_mat_rows_c12_dout),
    .src_rows_empty_n(in_mat_rows_c12_empty_n),
    .src_rows_read(inRange_U0_src_rows_read),
    .src_cols_dout(in_mat_cols_c14_dout),
    .src_cols_empty_n(in_mat_cols_c14_empty_n),
    .src_cols_read(inRange_U0_src_cols_read),
    .src_data_V_dout(24'd0),
    .src_data_V_empty_n(1'b1),
    .src_data_V_read(inRange_U0_src_data_V_read),
    .dst_data_V_din(inRange_U0_dst_data_V_din),
    .dst_data_V_full_n(out_mat_data_V_full_n),
    .dst_data_V_write(inRange_U0_dst_data_V_write)
);
...
fifo_w32_d2_A_x in_mat_rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A_x in_mat_cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w24_d2_A in_mat_data_V_U(
    ...
    .if_read(AXIstream2xfMat_U0_img_data_V_read)
);

fifo_w32_d2_A_x in_mat_rows_c11_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIstream2xfMat_U0_img_rows_out_din),
    .if_full_n(in_mat_rows_c11_full_n),
    .if_write(AXIstream2xfMat_U0_img_rows_out_write),
    .if_dout(in_mat_rows_c11_dout),
    .if_empty_n(in_mat_rows_c11_empty_n),
    .if_read(bgr2hsv_U0_p_src_mat_rows_read)
);

fifo_w32_d2_A_x in_mat_rows_c12_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIstream2xfMat_U0_img_rows_out1_din),
    .if_full_n(in_mat_rows_c12_full_n),
    .if_write(AXIstream2xfMat_U0_img_rows_out1_write),
    .if_dout(in_mat_rows_c12_dout),
    .if_empty_n(in_mat_rows_c12_empty_n),
    .if_read(inRange_U0_src_rows_read)
);

fifo_w32_d2_A_x in_mat_cols_c13_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIstream2xfMat_U0_img_cols_out_din),
    .if_full_n(in_mat_cols_c13_full_n),
    .if_write(AXIstream2xfMat_U0_img_cols_out_write),
    .if_dout(in_mat_cols_c13_dout),
    .if_empty_n(in_mat_cols_c13_empty_n),
    .if_read(bgr2hsv_U0_p_src_mat_cols_read)
);

fifo_w32_d2_A_x in_mat_cols_c14_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIstream2xfMat_U0_img_cols_out2_din),
    .if_full_n(in_mat_cols_c14_full_n),
    .if_write(AXIstream2xfMat_U0_img_cols_out2_write),
    .if_dout(in_mat_cols_c14_dout),
    .if_empty_n(in_mat_cols_c14_empty_n),
    .if_read(inRange_U0_src_cols_read)
);

fifo_w1_d2_A out_mat_data_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(inRange_U0_dst_data_V_din),
    .if_full_n(out_mat_data_V_full_n),
    .if_write(inRange_U0_dst_data_V_write),
...
start_for_bgr2hsvhbi start_for_bgr2hsvhbi_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_bgr2hsv_U0_din),
    .if_full_n(start_for_bgr2hsv_U0_full_n),
    .if_write(AXIstream2xfMat_U0_start_write),
    .if_dout(start_for_bgr2hsv_U0_dout),
    .if_empty_n(start_for_bgr2hsv_U0_empty_n),
    .if_read(bgr2hsv_U0_ap_ready)
);

start_for_inRangeibs start_for_inRangeibs_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_inRange_U0_din),
    .if_full_n(start_for_inRange_U0_full_n),
    .if_write(AXIstream2xfMat_U0_start_write),
    .if_dout(start_for_inRange_U0_dout),
    .if_empty_n(start_for_inRange_U0_empty_n),
    .if_read(inRange_U0_ap_ready)
);
...
assign AXIstream2xfMat_U0_img_data_V_dout = in_mat_data_V_dout;

assign AXIstream2xfMat_U0_img_data_V_empty_n = in_mat_data_V_empty_n;

assign AXIstream2xfMat_U0_img_data_V_read = 1'b0;

assign AXIstream2xfMat_U0_start_full_n = (start_for_inRange_U0_full_n & start_for_bgr2hsv_U0_full_n);
...
assign ap_idle = (xfMat2AXIstream_U0_ap_idle & inRange_U0_ap_idle & bgr2hsv_U0_ap_idle & Block_Mat_exit71_pro_U0_ap_idle & AXIstream2xfMat_U0_ap_idle);
...
assign bgr2hsv_U0_ap_continue = 1'b1;

assign bgr2hsv_U0_ap_start = start_for_bgr2hsv_U0_empty_n;

assign bgr2hsv_U0_start_full_n = 1'b1;

assign bgr2hsv_U0_start_write = 1'b0;

assign inRange_U0_ap_continue = 1'b1;

assign inRange_U0_ap_start = start_for_inRange_U0_empty_n;

assign inRange_U0_start_full_n = 1'b1;

assign inRange_U0_start_write = 1'b0;

assign start_for_bgr2hsv_U0_din = 1'b1;

assign start_for_inRange_U0_din = 1'b1;
